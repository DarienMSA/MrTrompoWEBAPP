...
public class dbConnection{
    ...
    static {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/mrtrompodb?useUnicode=true&useJDBCCompliantTimeZoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
