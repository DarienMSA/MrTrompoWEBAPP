 ...
 * @author 52811
 */
@WebServlet(name = "CuentaUsuarioController", urlPatterns = {"/CuentaUsuarioController"})
public class CuentaUsuarioController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CuentaUsuarioController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CuentaUsuarioController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("UserCuenta", User);
        List<address> direccionesUser = addressDAO.getAddressUser(emailActual);
        request.setAttribute("direccionesUser", direccionesUser);
        List<orden> ordenesUser = ordenDAO.getOrdenComplete(emailActual);
        request.setAttribute("ordenesUser", ordenesUser);
        ...
        request.getRequestDispatcher("cuentaUser.jsp").forward(request, response);
    }
