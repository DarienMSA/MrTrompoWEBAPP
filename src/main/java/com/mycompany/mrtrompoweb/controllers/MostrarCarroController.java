 ...
 * @author 52811
 */
@WebServlet(name = "MostrarCarroController", urlPatterns = {"/MostrarCarroController"})
public class MostrarCarroController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarCarroController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MostrarCarroController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<pedido> pedidosActivosUser = pedidoDAO.getPedidosActivosUser(emailActual);
        request.setAttribute("pedidosActivosUser", pedidosActivosUser);
